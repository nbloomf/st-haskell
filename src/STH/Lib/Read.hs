module STH.Lib.Read (
  readDecimalNat, readPosIntList, readHexadecimalNat, showBase86Nat, readBase86Nat, readCharRange
) where

import Control.Arrow ((>>>))
import STH.Lib.Maybe (filterMaybe)
...
readCharRange :: String -> Maybe String
readCharRange = fmap charSeqsToList . readCharSeqs . bsUnEsc
